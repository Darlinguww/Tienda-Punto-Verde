  ...
  return (
    ...
    >
      <div className="relative h-72 bg-slate-50 overflow-hidden">
        ...
        <button className="absolute bottom-6 right-6 w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-slate-900 shadow-xl shadow-slate-900/5 translate-y-24 group-hover:translate-y-0 transition-all duration-500 hover:bg-brand-primary hover:text-white">
      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-50">
          ...
          <button className="text-xs font-bold text-slate-400 hover:text-brand-primary transition-colors uppercase tracking-widest">Detalles</button>
        </div>
      </div>
    </motion.div>
  );
